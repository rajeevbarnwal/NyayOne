...
EXPECTED_NYAY18_NAMESPACE_GATE_TEST_SHA256 = (
    "edafec9651a1f2990aa591cad204a1589d60c7191b109ad281b08e537094bc21"
)
EXPECTED_NYAY18_NAMESPACE_CONTRACT_SHA256 = (
    "27e8cba47ea94092306989e33389d410b995fba66082b2ec6019f821d9cf4fcf"
)
...
def check_workflow(path: Path) -> list[str]:
    ...
    if path.name == "nyay66-conformance.yml":
        ...
        expected = "e038b23a6d4ce4b6f83c75588e7d0cfd0307aebd91f81eb05083e9dda006ecb0"
        return [] if hashlib.sha256(path.read_bytes()).hexdigest() == expected else [
