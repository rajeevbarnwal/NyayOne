...
describe('student screen registry (SAATHI-52/53/55/57/58)', () => {
  it('implements the canonical IDs delivered so far (S-01..S-30, S-50..S-65, S-90/S-91 calendar)', () => {
    const expected = [
      ...Array.from({ length: 30 }, (_, i) => `S-${String(i + 1).padStart(2, '0')}`), // S-01..S-26 + S-27..S-30 law schools (SAATHI-63)
